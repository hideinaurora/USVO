package org.example.service.web.impl;
...
@Service
public class WebApplyServiceImpl implements WebApplyService {
    ...
    public PageResult<ApplyDetailVO> queryPage(ApplyQueryDTO queryDTO) {
        ...
        // 5. 执行分页查询
        Page<ApplyEntity> pageResult = applyService.page(page, queryWrapper);
    ...
    public List<ApplyDetailVO> queryList() {
        ...
        QueryWrapper<ApplyEntity> queryWrapper = new QueryWrapper<>();
        queryWrapper.orderByDesc("gmt_create");
        List<ApplyEntity> entityList = applyService.list(queryWrapper);
    ...
    public ApplyDetailVO queryDetail(Long applyId) {
        ApplyEntity entity = applyService.getById(applyId);
        if (entity == null) {
            return null;
        }
    ...
    public Boolean delete(String applyIds) {
        ...
        return applyService.removeByIds(idList);
    }
