...
@Getter
@Setter
@Schema(description = "已报名活动详情")
public class EnrolledActivityVO implements Serializable {
    ...
    @Schema(description = "报名状态：0-未支付，1-已支付", example = "1")
    private Integer applyStatus;

    @Schema(description = "报名记录ID", example = "1")
    private Long enrollRecordId;

    @Schema(description = "报名时间", example = "2026-03-13 10:00:00")
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss", timezone = "GMT+8")
    private LocalDateTime enrollTime;

    @Schema(description = "支付订单信息")
    private ApplyPayVO payOrder;
